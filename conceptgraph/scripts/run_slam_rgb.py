...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--dataset_root",default="/Users/zhangjie/Downloads/Replica", type=Path,
    )
    parser.add_argument(
        "--dataset_config", default="/Users/zhangjie/Desktop/毕设/concept-graphs-main/conceptgraph/dataset/dataconfigs/replica/replica.yaml",type=str, 
        help="This path may need to be changed depending on where you run this script. "
    )
    parser.add_argument("--scene_id", type=str, default="room2")
